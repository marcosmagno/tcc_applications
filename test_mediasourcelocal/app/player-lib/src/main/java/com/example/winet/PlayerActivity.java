...
public class PlayerActivity extends AppCompatActivity {
  ...
  private DashMediaSource buildMediaSource() {
    ...
    DashChunkSource.Factory dashChunkSourceFactory = new DefaultDashChunkSource.Factory(
        ...
        CacheDataSource cacheDataSource =
            new CacheDataSource(cache, manifestDataSourceFactory.createDataSource(), CacheDataSource.FLAG_BLOCK_ON_CACHE);


    return new DashMediaSource.Factory(dashChunkSourceFactory,manifestDataSourceFactory).createMediaSource(cacheDataSource.getUri());
