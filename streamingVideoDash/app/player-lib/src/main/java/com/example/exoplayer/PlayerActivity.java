...
public class PlayerActivity extends AppCompatActivity {
  ...
  public TextView bitrateMetric = (TextView) findViewById(R.id.bitrateMetric);
  public TextView bytesTransfered = (TextView) findViewById(R.id.bytesTransfered);
  ...
  private final DefaultBandwidthMeter BANDWIDTH_METER = new DefaultBandwidthMeter(new Handler(), new BandwidthMeter.EventListener() {
    ...
    public void onBandwidthSample(int elapsedMs, long bytes, long bitrate) {
      ...
      Log.d("Bandwidth - bytes/s", String.valueOf(bitrate));
    }
  });
